...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '绿狮', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'http://notalion.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '游戏, 分享', // 网站关键词 英文逗号隔开
